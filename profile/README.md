...
| Repo | Stack |
| --- | --- |
| [minimal](https://github.com/aspect-starters/minimal) | An empty, correctly-configured Bazel workspace |
| [go](https://github.com/aspect-starters/go) | Go |
| [py](https://github.com/aspect-starters/py) | Python |
| [js](https://github.com/aspect-starters/js) | JavaScript & TypeScript |
| [java](https://github.com/aspect-starters/java) | Java |
| [kotlin](https://github.com/aspect-starters/kotlin) | Kotlin |
| [scala](https://github.com/aspect-starters/scala) | Scala |
| [cpp](https://github.com/aspect-starters/cpp) | C & C++ |
| [rust](https://github.com/aspect-starters/rust) | Rust |
| [ruby](https://github.com/aspect-starters/ruby) | Ruby |
| [shell](https://github.com/aspect-starters/shell) | Bash / shell |
| [kitchen-sink](https://github.com/aspect-starters/kitchen-sink) | Everything — all languages + OCI, protobuf, release stamping, codegen |
